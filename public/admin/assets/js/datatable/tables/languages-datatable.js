$(document).ready(function () {
    ...
    $(".languages tfoot th").each(function () {
        var title = $(this).text();
...
//            }  
        ...
        language: {
            ...
            info: "Showing _START_ to _END_ of _TOTAL_ Language",
            infoEmpty: "Showing 0 to 0 of 0 Language",
            infoFiltered: "(filtered from _MAX_ total Language)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ Language",
            loadingRecords: "Loading...",
            processing: "Processing...",
            search: "Search:",
            zeroRecords: "No matching Language found",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
