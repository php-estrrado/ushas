$(document).ready(function () {
    ...
    $(".chatlist tfoot th").each(function () {
        var title = $(this).text();
        $(this).html('<input type="text" placeholder="' + title + '" />');
    });

    var table = $(".chatlist").DataTable({
        pageLength: 10,
        rowReorder: false,
        colReorder: true,
        paging: true,
...
//            }  
        ...
        language: {
            decimal: "",
            emptyTable: "No chat found",
            info: "Showing _START_ to _END_ of _TOTAL_ chat",
            infoEmpty: "Showing 0 to 0 of 0 chat",
            infoFiltered: "(filtered from _MAX_ total chat)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ chat",
            loadingRecords: "Loading...",
            processing: "Processing...",
            search: "Search:",
            zeroRecords: "No matching chat found",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
