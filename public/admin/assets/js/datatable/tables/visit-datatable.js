$(document).ready(function () {
    ...
    $(".visit-table tfoot th").each(function () {
        var title = $(this).text();
...
//            }  
        ...
        language: {
            decimal: "",
            emptyTable: "No visit found",
            info: "Showing _START_ to _END_ of _TOTAL_ visit",
            infoEmpty: "Showing 0 to 0 of 0 visit",
            infoFiltered: "(filtered from _MAX_ total visit)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ visit",
            loadingRecords: "Loading...",
            processing: "Processing...",
            search: "Search:",
            zeroRecords: "No matching visit found",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
