$(document).ready(function () {
    ...
    $(".auctionslog tfoot th").each(function () {
        var title = $(this).text();
        $(this).html('<input type="text" placeholder="' + title + '" />');
    });

    var table = $(".auctionslog").DataTable({
        pageLength: 10,
        rowReorder: false,
        colReorder: true,
        paging: true,
        ...
        buttons: [
            ...
            
            {
                ...
                title: "MJS - Auctionslog",
                titleAttr: "Export to Excel",
                filename: "MJS_Auctionslog",
                exportOptions: {
...
//            }  
        ...
        language: {
            decimal: "",
            emptyTable: "No auctionslog found",
            info: "Showing _START_ to _END_ of _TOTAL_ auctionslog",
            infoEmpty: "Showing 0 to 0 of 0 auctionslog",
            infoFiltered: "(filtered from _MAX_ total auctionslog)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ auctionslog",
            loadingRecords: "Loading...",
            processing: "Processing...",
            search: "Search:",
            zeroRecords: "No matching auctionslog found",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
