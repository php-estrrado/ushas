$(document).ready(function () {
    ...
    $(".auctions_refund_request tfoot th").each(function () {
        var title = $(this).text();
        $(this).html('<input type="text" placeholder="' + title + '" />');
    });

    var table = $(".auctions_refund_request").DataTable({
        pageLength: 10,
        rowReorder: false,
        colReorder: true,
        paging: true,
        ...
        buttons: [
            ...
            
            {
                ...
                title: "MJS - Auctions Refund Request",
                titleAttr: "Export to Excel",
                filename: "MJS_refund_request",
                exportOptions: {
...
//            }  
        ...
        language: {
            decimal: "",
            emptyTable: "No auctions refund request found",
            info: "Showing _START_ to _END_ of _TOTAL_ auctions refund request",
            infoEmpty: "Showing 0 to 0 of 0 auctions refund request",
            infoFiltered: "(filtered from _MAX_ total auctions refund request)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ auctions refund request",
            loadingRecords: "Loading...",
            processing: "Processing...",
            search: "Search:",
            zeroRecords: "No matching auctions refund request found",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
