$(document).ready(function () {
    ...
    $(".currencies tfoot th").each(function () {
        var title = $(this).text();
...
//            }  
        ...
        language: {
            decimal: "",
            emptyTable: "No currency found",
            info: "Showing _START_ to _END_ of _TOTAL_ currency",
            infoEmpty: "Showing 0 to 0 of 0 currency",
            infoFiltered: "(filtered from _MAX_ total currency)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ currency",
            loadingRecords: "Loading...",
            processing: "Processing...",
            search: "Search:",
            zeroRecords: "No matching currency found",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
