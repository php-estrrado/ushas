$(document).ready(function () {
    ...
    var table = $(".loyalty_log_list").DataTable({
        pageLength: 10,
        rowReorder: false,
        colReorder: true,
        paging: true,
        ...
        buttons: [
            ...
            
            {
                ...
                title: "MJS - Blog Categories",
                titleAttr: "Export to Excel",
                filename: "MJS_BlogCategories",
                exportOptions: {
...
//            }  
        ...
        language: {
            decimal: "",
            emptyTable: "No Loyalty Log found",
            info: "Showing _START_ to _END_ of _TOTAL_ Loyalty Log",
            infoEmpty: "Showing 0 to 0 of 0 Loyalty Log",
            infoFiltered: "(filtered from _MAX_ total Loyalty Log)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ Loyalty Log",
            loadingRecords: "Loading...",
            processing: "Processing...",
            search: "Search:",
            zeroRecords: "No matching Loyalty Log found",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
