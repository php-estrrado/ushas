$(document).ready(function () {
    ...
    $(".discountlist tfoot th").each(function () {
        var title = $(this).text();
        $(this).html('<input type="text" placeholder="' + title + '" />');
    });

    var table = $(".discountlist").DataTable({
        pageLength: 10,
        rowReorder: false,
        colReorder: true,
        paging: true,
...
//            }  
        ...
        language: {
            decimal: "",
            emptyTable: "No discount found",
            info: "Showing _START_ to _END_ of _TOTAL_ discounts",
            infoEmpty: "Showing 0 to 0 of 0 discount",
            ...
            search: "Search:",
            zeroRecords: "No matching discount found",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
