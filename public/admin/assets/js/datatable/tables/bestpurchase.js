$(document).ready(function () {
    ...
    $(".bestpurchases tfoot th").each(function () {
        var title = $(this).text();
        $(this).html('<input type="text" placeholder="' + title + '" />');
    });

    var table = $(".bestpurchases").DataTable({
        pageLength: 10,
        rowReorder: false,
        colReorder: true,
        paging: true,
...
//            }  
        ...
        language: {
            decimal: "",
            emptyTable: "No purchase found",
            info: "Showing _START_ to _END_ of _TOTAL_ purchase",
            infoEmpty: "Showing 0 to 0 of 0 purchase",
            infoFiltered: "(filtered from _MAX_ total purchase)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ purchase",
            loadingRecords: "Loading...",
            processing: "Processing...",
            search: "Search:",
            zeroRecords: "No matching purchase found",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
