$(document).ready(function () {
    ...
    $(".taxlist tfoot th").each(function () {
        var title = $(this).text();
        $(this).html('<input type="text" placeholder="' + title + '" />');
    });

    var table = $(".taxlist").DataTable({
        pageLength: 10,
        rowReorder: false,
        colReorder: true,
        paging: true,
...
//            }  
        ...
        language: {
            ...
            info: "Showing _START_ to _END_ of _TOTAL_ taxes",
            infoEmpty: "Showing 0 to 0 of 0 taxes",
            infoFiltered: "(filtered from _MAX_ total taxes)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ taxes",
