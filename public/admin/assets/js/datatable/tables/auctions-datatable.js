$(document).ready(function () {
    ...
    $(".auctionslist tfoot th").each(function () {
        var title = $(this).text();
        $(this).html('<input type="text" placeholder="' + title + '" />');
    });

    var table = $(".auctionslist").DataTable({
        pageLength: 10,
        rowReorder: false,
        colReorder: true,
        paging: true,
...
//            }  
        ...
        language: {
            ...
            infoEmpty: "Showing 0 to 0 of 0 auctions",
            infoFiltered: "(filtered from _MAX_ total auctions)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ auctions",
            loadingRecords: "Loading...",
            processing: "Processing...",
            search: "Search:",
            zeroRecords: "No matching auctions found",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
