$(document).ready(function () {
    ...
    $(".shockingsales tfoot th").each(function () {
        var title = $(this).text();
        $(this).html('<input type="text" placeholder="' + title + '" />');
    });

    var table = $(".shockingsales").DataTable({
        pageLength: 10,
        rowReorder: false,
        colReorder: true,
        paging: true,
        ...
        buttons: [
            ...
            
            {
                ...
                title: "MJS - Shocking Sales",
                titleAttr: "Export to Excel",
                filename: "MJS_Shockingsales",
                exportOptions: {
...
//            }  
        ...
        language: {
            decimal: "",
            emptyTable: "No shocking sales found",
            info: "Showing _START_ to _END_ of _TOTAL_ shocking sales",
            infoEmpty: "Showing 0 to 0 of 0 shocking sales",
            infoFiltered: "(filtered from _MAX_ total shocking sales)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ shocking sales",
            loadingRecords: "Loading...",
            processing: "Processing...",
            search: "Search:",
            zeroRecords: "No matching shocking sales found",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
    ...
    $("thead tr th:first-child, thead tr th:last-child").removeClass("sorting_desc");
     $('#shockingsales td').css('white-space','initial');
});