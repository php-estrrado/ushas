$(document).ready(function() {
    ...
    $(".customer-request tfoot th").each(function() {
        var title = $(this).text();
        $(this).html('<input type="text" placeholder="' + title + '" />');
    });

    var table = $(".customer-request").DataTable({
        pageLength: 10,
        rowReorder: false,
        colReorder: true,
        paging: true,
        ...
        language: {
            ...
            info: "Showing _START_ to _END_ of _TOTAL_ customer",
            infoEmpty: "Showing 0 to 0 of 0 attributes",
            infoFiltered: "(filtered from _MAX_ total customer)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ customer",
