$(document).ready(function () {
    ...
    $(".userroles tfoot th").each(function () {
        var title = $(this).text();
...
//            }  
        ...
        language: {
            decimal: "",
            emptyTable: "No user roles found",
            info: "Showing _START_ to _END_ of _TOTAL_ user roles",
            infoEmpty: "Showing 0 to 0 of 0 user roles",
            infoFiltered: "(filtered from _MAX_ total user roles)",
            infoPostFix: "",
            thousands: ",",
            ...
            search: "Search:",
            zeroRecords: "No matching user roles found",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
