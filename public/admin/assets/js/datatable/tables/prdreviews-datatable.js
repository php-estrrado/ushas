$(document).ready(function () {
    ...
    $(".prdreview tfoot th").each(function () {
        var title = $(this).text();
        $(this).html('<input type="text" placeholder="' + title + '" />');
    });

    var table = $(".prdreview").DataTable({
        pageLength: 10,
        rowReorder: false,
        colReorder: true,
        paging: true,
...
//            }  
        ...
        language: {
            ...
            info: "Showing _START_ to _END_ of _TOTAL_ review",
            infoEmpty: "Showing 0 to 0 of 0 review",
            infoFiltered: "(filtered from _MAX_ total review)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ review",
