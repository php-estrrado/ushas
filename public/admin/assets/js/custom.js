...
jQuery(".slide-menu li.active").parents(".slide").find(".side-menu__item").addClass("active");
jQuery(".slide-menu li.active").parents(".slide").addClass("is-expanded");
jQuery(".slide-menu li.active a.slide-item").addClass("active");
...
$.fn.stars = function() {
    return $(this).each(function() {
        ...
        var fullStar = new Array(Math.floor(rating + 1)).join('<i class="fa fa-star text-warning"></i>');
        var halfStar = ((rating%1) !== 0) ? '<i class="fa fa-star-half-alt text-warning"></i>': '';
...
$.fn.stars = function() {
    return $(this).each(function() {
        ...
        const fullStar = '<i class="fa fa-star text-warning"></i>'.repeat(Math.floor(rating));
        const halfStar = (rating%1!== 0) ? '<i class="fa fa-star-half-alt text-warning"></i>': '';
