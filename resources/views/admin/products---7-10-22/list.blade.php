...
required: "Status field is required."
        ...
        $('body').on('change','#lang_id',function(){ 
            ...
            $.ajax({
                type: "GET",
                url: '{{url("admin/product")}}/'+pid+"/"+0+"/edit/"+id+"/",
                data: { page: 'seller_product'},
                success: function (data) { $('.bd-example-modal-sm').modal('hide'); 
                    $('body #content_detail').html(data); $('body #content_detail').fadeIn(700); $('#content_list').hide(); 
                    $('body #content_detail .no-disp').hide();   $('#editBtn-'+id+' span').text('Edit');  $('#editBtn-'+id).prop('disabled',false);
        ...
        $("body").on("change", ".status-btn", function () {
            ...
            if (sts == true){ var status = 1; }else if (sts == false){var status = 0; smsg = 'Product deactivated successfully!'; }
...
function build_table(){ 
        ...
        if(jQuery("#attr-val-content-1 .attr_value").length >0) {
            ...
            if($('.prod_attr_1 #attr_name_1').val() !="") {
                thead_html ='<thead><tr><th class="text-center init_name">'+$('.prod_attr_1 #attr_name_1').val()+'</th><th class="text-center">Price</th><th class="text-center">Stock</th><th class="text-center">SKU</th><th class="text-center">Sale Price</th> <th class="text-center">Sale From</th><th class="text-center">Sale To</th> <th class="text-center">Sale Price</th> <th class="text-center">Sale From</th><th class="text-center">Sale To</th>ge</th><th class="text-center">Weight</th><th class="text-center">Length</th><th class="text-center">Width</th><th class="text-center">Height</th></tr></thead>';
            }else {
