        ...
        <div class="page-header">
            ...
            <div class="page-rightheader" style="display:flex; flex-direction: row; justify-content: center; align-items: center">
                ...
                <div class="btn btn-list">
                    <a href="{{ url('admin/delivery/create/') }}"  class="btn btn-primary addmodule"><i class="fe fe-plus mr-1"></i> Add New</a>
                </div>
            </div>
        </div>
    <!--End Page header-->
                    								...
                    								@foreach($delivery as $row)
														<tr>
                                                            ...
                                                            <td class="align-middle" >
                                                                <div class="d-flex">
                                                                    @php	$delivery_type_name = Str::of($row['delivery_type_name'])->limit(20); @endphp
                                                                    <p>{{$delivery_type_name}}</p>
                                                                </div>
                                                            </td>
                                                            <td class="align-middle" >
                                                                <div class="d-flex">
                                                                    <p>{{$row['delivery_description']}}</p>
                                                                </div>
                                                            </td>																	
                                                            ...
                                                            <td class="align-middle">
                                                                <div class="btn-group align-top">
                                                                    <a href="{{ url('admin/delivery/edit/') }}/{{ $row['id'] }}"   class="mr-2 btn btn-info btn-sm editmodule"><i class="fe fe-edit mr-1"></i> Edit</a>
