								...
								<div class="e-table">
									<div class="table-responsiv table-lg mt-3">
										{{ Form::open(array('url' => "/admin/delivery/save", 'id' => 'deliveryForm', 'name' => 'deliveryForm', 'class' => '')) }}
										    {{Form::hidden('id',$delivery_data['id'],['id'=>'deliveryid'])}}
                                            {{Form::hidden('cnt_id',$delivery_data['cnt_id'],['id'=>'content_id'])}}
                                            <div class="py-1">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <label class="form-label">Delivery Type Name <span class="text-red">*</span></label>
                                                            {!! Form::text('delivery_type', $delivery_data['delivery_type_name'], ['class' => 'form-control','rows' => 3,'id'=>'delivery_type']) !!}
                                                        </div>
                                                        @error('delivery_type')
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            {!! Form::textarea('delivery_description', $delivery_data['delivery_description'], ['class' => 'form-control','rows' => 4,'cols'=>54, 'id'=>'delivery_description']) !!}
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            {!! Form::text('delivery_charges', $delivery_data['delivery_charges'], ['class' => 'form-control','rows' => 3,'id'=>'delivery_charges']) !!}
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col d-flex justify-content-end">
                                                        <a href="{{url('/admin/delivery')}}"  class="mr-2 btn btn-secondary" >Cancel</a>
