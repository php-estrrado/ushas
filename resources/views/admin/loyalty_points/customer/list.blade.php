											...
											<div class="card-body">
												<div class="e-table">
													<div class="table-responsive table-lg mt-3">
														<table class="table table-bordered border-top text-nowrap loyalty_customer_list" id="loyalty_customer_list" style="width: 100%">
															<thead>
																<tr>
																	<th class="align-top border-bottom-0 wd-5 notexport">Select</th>
																	<th class="border-bottom-0 w-15">Customer Name</th>
																	<th class="border-bottom-0 w-15"> Balance Points</th>
																	<th class="border-bottom-0 w-15">Total Points</th>
														...
														{{Form::hidden('listUrl',route('loyalty-customer.list'),['id'=>'listUrl'])}}
													</div>
												</div>
											</div>
										</div>
...
@section('js')
		...
		<script src="{{URL::asset('admin/assets/js/datatable/tables/loyalty_customer_list-datatable.js')}}"></script>
	<!-- INTERNAL Popover js -->
