        ...
        $lang_id = $content_table->lang_id;
         ...
         @endphp
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="d-flex">
                                                                <img src="{{ url('uploads/storage/app/public/brands/'.$brand['image']) }}" alt="{{ $brand['image'] }}"  style="height: 150px; max-height:150px; width:auto;">
                                                                <input type="hidden" value="{{ $brand['image'] }}" name="image_file">
                                                            </div>
                                                        </div>
                                                        </div>
                                                        @endif
