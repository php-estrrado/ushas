...
$pStatusList    =   ['pending'=>'Pending','paid'=>'Paid']; 
@endphp
...
<script>
    ...
    $(document).ready(function(){ 
        ...
        $('body').on('change','#start_date',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '{{url("admin/sales/orders/$type")}}',
                data: {start_date: this.value, end_date: $('#end_date').val(),seller: $('#seller').val(),o_status: $('#o_status').val(),p_status: $('#p_status').val(),viewType: 'ajax'},
                success: function (data) {
        ...
        $('body').on('change','#end_date',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '{{url("admin/sales/orders/$type")}}',
                data: {end_date: this.value, start_date: $('#start_date').val(),seller: $('#seller').val(),o_status: $('#o_status').val(),p_status: $('#p_status').val(),viewType: 'ajax'},
                success: function (data) {
                    $('#content_list').html(data); 
                } 
            });
        ...
        $('body').on('change','#seller',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '{{url("admin/sales/orders/$type")}}',
                data: {seller: this.value, start_date: $('#start_date').val(),end_date: $('#end_date').val(),o_status: $('#o_status').val(),p_status: $('#p_status').val(),viewType: 'ajax'},
                success: function (data) {
                    $('#content_list').html(data); 
                } 
            });
