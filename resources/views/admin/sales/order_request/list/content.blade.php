                                            ...
                                            @foreach($orders as $row) @php $n++; @endphp <?php // echo '<pre>'; print_r($row->address); echo '</pre>'; die; ?>
                                                ...
                                                <tr class="dtrow" id="dtrow-{{$row->id}}">
                                                    ...
                                                    <td class="text-center">
                                                        <button id="acceptBtn-{{$row->id}}" class="mr-2 btn btn-success btn-sm acceptBtn" data-val="accepted"><i class="fa fa-check mr-1"></i>Accept</button>
                                                        <button id="denyBtn-{{$row->id}}" class="mr-2 btn btn-danger btn-sm denyBtn" data-val="cancel_initiated" data-toggle="modal" data-target=".bd-example-modal-sm"><i class="fa fa-ban mr-1"></i>Cancel</button>
