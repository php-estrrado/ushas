...
<div id="content_list">@include('admin.sales.cancel_order.list.content')</div>
...
<script>
    ...
    $(document).ready(function(){ 
        ...
        $('body').on('click','.viewDtl',function(){ 
            ...
            $.ajax({
                type: "GET",
               url: '{{url("admin/sales/cancel/order")}}/'+id,
        ...
        $('body').on('click','#accept_btn',function(){ 
            ...
            var desc        =   'Cancellation accepted';
            swal({
        ...
        $('body').on('click', '#reply_submit', function(){
           if($('.modal-content #reply').val() == ''){ $('.modal-content #reply_error').text('Comment field is required'); return false; }else{ $('.modal-content #reply_error').text(''); }
            ...
            var url         =   '{{url("admin/sales/order/updateStatus")}}';
            var smsg        =   'Request '+status+' successfully!';
            var desc        =   'Cancellation rejected';
        ...
        $('body').on('change','#start_date',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '{{url("admin/sales/cancel/orders")}}',
        ...
        $('body').on('change','#end_date',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '{{url("admin/sales/cancel/orders/$type")}}',
