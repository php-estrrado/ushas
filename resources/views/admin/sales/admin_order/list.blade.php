...
<div id="content_list">@include('admin.sales.admin_order.list.content')</div>
...
<script>
    ...
    $(document).ready(function(){ 
        ...
        $('body').on('click','.viewDtl',function(){ 
            ...
            $.ajax({
                type: "GET",
               url: '{{url("admin/sales/admin-sales/order")}}/'+id+"/request",
        ...
        $('body').on('change','#start_date',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '{{url("admin/sales/admin-sales")}}',
        ...
        $('body').on('change','#seller',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '{{url("admin/sales/admin-sales/orders")}}',
