...
{{ Form::open(array('url' => "admin/brands/save", 'id' => 'brandsForm', 'name' => 'brandsForm', 'class' => '','files'=>'true')) }}
												{{Form::hidden('id',0,['id'=>'id'])}}
														...
														<div class="row">
																...
																<div class="row">
																	<div class="col mb-3">
																		<div class="form-group">
																			...
																			{!! Form::textarea('brand_desc', null, ['class' => 'form-control','id'=>'brand_desc', 'rows' => '3']) !!}
																		</div>
																	@error('brand_desc')
																	<p style="color: red">{{ $message }}</p>
																	@enderror
                                                           ...
                                                           <input type="file" class="dropify @error('brand_image') is-invalid @enderror" data-height="180"  accept="image/*" name="brand_image" data-allowed-file-extensions='["png", "jpg", "jpeg"]' />
