                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content col-12">
                            <div class="tab-pane active " id="tab1">
                                ...
                                <div class="page-rightheader tar pr-6">
                                    <div class="btn btn-list">
                                        <a href="" id="editForm-{{$product->id}}" data-seller="0" data-product="{{$product->id}}" class="btn btn-secondary editForm"><i class="fe fe-plus mr-1"></i> Add Stock</a>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane " id="tab2">
                                ...
                                <div class="page-rightheader tar pr-6">
                                    <div class="btn btn-list">
                                        <a href="" id="addPice-{{$product->id}}" data-seller="0" data-product="{{$product->id}}" class="btn btn-secondary addPice"><i class="fe fe-plus mr-1"></i> Add Price</a>
                                    </div>
                                </div>
