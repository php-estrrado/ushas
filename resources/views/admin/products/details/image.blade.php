@php $n_img = 0; $imgc=0;@endphp
    ...
    <div class="col-12 mb-4">
        ...
        <div id="prdImg-{{$img->id}}" class="col-md-3 col-sm-6 mb-3 fl imgDiv">
            ...
            {{Form::hidden('imgArr[]',1,['id'=>'ad_img_arr_id'])}}
        </div>
        @php $imgc++;@endphp
        @endforeach
    </div>
    ...
    <div id="prd_imgs">
        <div id="img_row_0" class="col-12 fl img_row">
            ...
            <div class="col-lg-6 fl">
                <div class="form-group">
                    ...
                    {{Form::file('image[]',['id'=>'image_'.$n_img,'class'=>'form-control img crp_img','placeholder'=>'Choose Image','accept'=>'image/*','data-img'=>$n_img])}}
        ...
        <div class="col-lg-5 col-8 fl">
                <div class="form-group">
                    ...
                    <input type="hidden" name="img_crp[]" id="image_{{$n_img}}_img">
                </div>
...
<div id="add_more_img" class="d-none">
    <div id="img_row_id" class="col-12 fl img_row">
        <div class="col-lg-6 fl">
            <div class="form-group">
                {{Form::file('image[]',['id'=>'image_file_id','class'=>'form-control img crp_img','placeholder'=>'Choose Image','accept'=>'image/*','data-img'=>$n_img])}}
            </div>
        </div>
        <div class="col-lg-5 col-8 fl">
            <div class="form-group">
...
<!-- INTERNAL File uploads js -->
        ...
        <script>
        var row      =   parseInt('{{$imgc}}');
        var count_loop=   parseInt('{{$n_img}}');
