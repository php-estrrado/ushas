 ...
 <?php if($prdType !="") { if($prdType ==1) { $simple_prod = "display:block;"; $var_prod = "display:none;"; }else {  $simple_prod = "display:none;"; $var_prod = "display:block;"; } }else { $simple_prod = "display:block;"; $var_prod = "display:none;"; }  ?>
   ...
   <div class="col-lg-6 fl">
        <div class="form-group">
            ...
            {{Form::number('price[sale_price]',$sPrice,['id'=>'sale_price','class'=>'form-control ','readonly','placeholder'=>'Sale Price','max'=>9999999999])}}
            <span class="error"></span>
        </div>
    </div> 
    <div class="clearfix"></div>
    ...
    <div class="col-lg-6 fl">
        <div class="form-group">
            {{Form::label('stock','Stock',['class'=>''])}}
             {{Form::number('price[stock]',$stock_val,['id'=>'stock', 'class'=>'form-control','placeholder'=>'Stock','max'=>9999])}}
            <span class="error"></span>
        </div>
    </div>
     <div class="col-lg-6 fl">
...
<div class="tab-content col-12">
    ...
    <div class="col-lg-6 fl">
        <div class="form-group">
            {{Form::label('min_order','Minimum Order Quantity',['class'=>''])}}
             {{Form::number('prd[min_order]',$min_order,['id'=>'min_order', 'class'=>'form-control','placeholder'=>'Quantity','max'=>9999])}}
     ...
     <div class="col-lg-6 fl">
        <div class="form-group">
            {{Form::label('bulk_order','Bulk Order Quantity',['class'=>''])}}
             {{Form::number('prd[bulk_order]',$bulk_order,['id'=>'bulk_order', 'class'=>'form-control','placeholder'=>'Quantity','max'=>9999])}}
                                    ...
                                    <div id="attr-val-content-1" > 
                                        ...
                                        ?>  
                                            ...
                                            <div class="mb-1">
                                                ...
                                                {{Form::text("attr_1_value[attr1_$att1_k][]",$att1_v['name'],['id'=>'attr_val_id','class'=>'form-control attr_value required','placeholder'=>'Enter Variation Options, eg: Red, etc.','data-val'=>"attr1_$att1_k"])}}
                                            <span class="error"></span>
                                            </div>
                                            </div>
                                            <?php if($attr_1_img !=""){
                                ...
                                <div class="clr"></div>
                                    ...
                                    <div id="attr-val-content-2" > 
                                        ...
                                        ?>  
                                            ...
                                            <div class="mb-1">
                                                {{form::label('attr_val_id','Options',['class'=>'m-0'])}}
                                                {{Form::text("attr_2_value[attr2_$att2_k][]",$att2_v['name'],['id'=>'attr_val_id','class'=>'form-control attr_value required','placeholder'=>'Enter Variation Options, eg: Red, etc.','data-val'=>"attr2_$att2_k"])}}
                                            <span class="error"></span>
                                            </div>
                                            </div>
...
<!-- Existing Dimensions -->
 ...
 <?php if($attr_weight !="" || $attr_length !="" || $attr_width !="" || $attr_height !=""){     ?>
            ...
            $at_2 = 0;
                ...
                $row_name = "[$dyk][$dyk2]";
                ?>
                @include('admin.products.details.shipping')
                <?php 
                 } 
            }else { 
