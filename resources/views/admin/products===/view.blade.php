            ...
            {{ Form::open(array('url' => "my-products/product/save", 'id' => 'adminForm', 'name' => 'adminForm', 'class' => '','files'=>'true')) }}
                ...
                <div class="tabs-menu mb-4">
                    <ul class="nav panel-tabs">
                        ...
                        <li><a href="#tab4" data-toggle="tab" id="nav_tab_4" ><span>Extra Fields</span></a></li>
                        <li><a href="#tab2" data-toggle="tab" id="nav_tab_2"><span>Product Info.</span></a></li>
                        <li><a href="#tab6" data-toggle="tab" id="nav_tab_5"><span>Reviews</span></a></li>
                ...
                <div class="col-lg-12">
                    <div class="card-footer text-right">
                        ...
                        <a href="{{url('admin/seller/products')}}" type="button" class="btn btn-secondary" data-dismiss="modal">Back</a>
