...
if($product){ 
    ...
    $prdAssFields    =   $product->assignedFlds($product->id); $fixedprice         =   $product->fixed_price; // dd($prdAssFields); 
    ...
    $status         =   $product->is_active;      if(isset($product->tax)){  $taxId          =   $product->tax->id; }else{ $taxId          =0; }           
    if(isset($prices)) { $price          =       $prices->price; $sPrice         =   $prices->sale_price; $stDate         =       $prices->sale_start_date; $edDate         =   $prices->sale_end_date;   }else { $price          =      0; $sPrice         =   0; $stDate         =       ""; $edDate         =  "";  } 
    ...
    $weight  =   $length  =   $width  =   $height  =  ''; $commission = 0; $commi_type = '%'; $fixedprice         =   '0.00';
    ...
    $status         =   1;  $featured   = $daily_deals      = $out_of_stock_selling    = 0; $sellerId = $seller->seller_id; $sellCkd = true; $adminCkd = false; $prdAssAttrs = $prdAssFields = []; $id = 0;
}
            ...
            {{ Form::open(array('url' => "admin/seller/product/save", 'id' => 'adminForm', 'name' => 'adminForm', 'class' => '','files'=>'true')) }}
                ...
                <div class="tabs-menu mb-4">
                    <ul class="nav panel-tabs">
                        ...
                        <li><a href="#tab4" data-toggle="tab" id="nav_tab_4" style="display: none;"><span>Extra Fields</span></a></li>
