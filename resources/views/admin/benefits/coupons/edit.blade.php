  ...
  $def_lang =DB::table('glo_lang_lk')->where('is_active', 1)->first();
        ...
        $lang_id = $content_table->lang_id;
         ...
         @endphp
                    ...
                    <img id="image_img" @if($coupon['image']) src="{{ config('app.storage_url').$coupon['image'] }}" @else src="{{url('storage/app/public/default.png')}}" @endif alt="coupon_img" style="height: 100px;" />
