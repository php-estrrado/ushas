											...
											<div class="card-body">
												<div class="e-table">
													<div class="table-responsive table-lg mt-3">
														<table class="table table-bordered border-top text-nowrap discountlist" id="discountlist">
															<thead>
																<tr>
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="align-middle" >
																		<div class="d-flex">
																			<span style="display:none;">{{date('Ymd',strtotime($row->valid_to))}}</span>
																			{{date('d M Y',strtotime($row->valid_to))}}
																		</div>
																	</td>
																	
																
																	<td class="text-nowrap align-middle"><span style="display:none;">{{date('Ymd',strtotime($row->created_at))}}</span><span>{{date('d M Y',strtotime($row->created_at))}}</span></td>
...
@section('js')
		...
		<script src="{{URL::asset('admin/assets/js/datatable/tables/discountlist-datatable.js')}}"></script>
