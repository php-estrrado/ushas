...
<div class="page-header">
    <div class="page-leftheader">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#"><i class="fe fe-grid mr-2 fs-14"></i>Language</a></li>
    ...
    <div class="page-rightheader" style="display:flex; flex-direction: row; justify-content: center; align-items: center">
								...
								<div class="btn btn-list">
									...
									<a href="{{ route('admin.newlanguage') }}"   class="btn btn-primary addmodule"><i class="fe fe-plus mr-1"></i> Add New</a>
...
<div id="content_list">@include('admin.language.list')</div>
