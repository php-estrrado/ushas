<!doctype html>
        ...
        * {
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tbody><tr>
            <td style="padding-right: 0px;padding-left: 0px;" align="center">
              ...
              <img align="center" border="0" src="{{URL::asset('admin/assets/images/email/lock.png')}}" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 10%;max-width: 58px;" width="58">
        ...
        <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; color: #b3b3b3;">We have sent you this email in response to your request to reset your password on {{ ucfirst(geSiteName()) }}.</span></p>
        <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
