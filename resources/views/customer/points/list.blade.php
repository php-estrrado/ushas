						...
						<div class="page-header">
							...
							<div class="page-rightheader">
								<div class="btn btn-list">
									...
									<!-- <a href="{{ url('/admin/customer/points/add/') }}" class="btn btn-primary addmodule"><i class="fe fe-plus mr-1"></i> Add New </a> -->
														...
														<table class="customer-table table table-bordered border-top text-nowrap" id="customer-table">
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="align-middle" >
																		<div class="d-flex">
																				<h6 class=" font-weight-bold">@if($row->total>0){{$row->total}}@else{{"0"}}@endif</h6>
                                                                        </div>
																	</td>
																	<td class="align-middle">
																		<div class="btn-group align-top">

																			<a href="{{ url('admin/customer/points-log/') }}/{{$row->user_id}}" class="btn btn-sm btn-primary mr-2"><i class="fe fe-list mr-1"></i> Log</a>&nbsp;

																			<!-- <a href="{{ url('admin/customer/points-manage/') }}/{{$row->user_id}}" class="btn btn-sm btn-primary "><i class="fe fe-list mr-1"></i> Manage</a>&nbsp; -->
