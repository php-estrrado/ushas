		...
		<!-- Custom js-->
		<script src="<?php echo e(URL::asset('admin/assets/js/custom.js')); ?>"></script><?php /**PATH C:\wamp64\www\ushas-dev\resources\views/layouts/custom-footer-scripts.blade.php ENDPATH**/ ?>