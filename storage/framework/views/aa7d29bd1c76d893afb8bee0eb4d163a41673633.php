							...
							<div class="col-12">
								...
								<div class="row flex-lg-nowrap">
									<div class="col-12 mb-3">
											<div class="card">
                                                <div class="card-body">
                                                    <form action="<?php echo e(url('admin/insert-subcategory')); ?>" method="POST" id="subcatForm" enctype="multipart/form-data">
													<?php echo csrf_field(); ?>
                                                    <div class="row">
                                                        <div class="col-md-12">
...
unset($__errorArgs, $__bag); ?>" name="category" id="category_id" onchange="loadsubcat()">
                                                                    ...
                                                                    ?>
                                                                    <option value="<?php echo e($cat->category_id); ?>"><?php echo e($category_name->content); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
...
unset($__errorArgs, $__bag); ?>" placeholder="Sub Category" value="<?php echo e(old('sub_category_name')); ?>" name="sub_category_name">-->
                                                                <input type="hidden" name="id" id="curent_subid" value="0" />
                                                                
                                                                 <?php echo e(Form::select('sub_category_name',$subcategories,'',['id'=>'sub_category_name','class'=>'form-control','placeholder'=>'Select Subcategory'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <a href="#"  data-target="#subitem-modal" data-toggle="modal" class="btn btn-danger fr addmodule"> Add New</a>
                                                        </div>
                                                        <!--<div class="col-md-12">-->
                                                        <!--    <div class="form-group">-->
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="modal fade" role="dialog" tabindex="-1" id="subitem-modal">
                                    <div class="modal-dialog modal-sm" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Create Subcategory Item</h5>
                                                <button type="button" class="close" data-dismiss="modal">
                                                    <span aria-hidden="true">×</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                <?php echo e(Form::open(array('url' => "admin/subcategory-item", 'id' => 'subitemForm', 'name' => 'subitemForm', 'class' => '','files'=>'true'))); ?>
                                                ...
                                                <div class="py-1">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <div class="form-group">
                                                                            <label>Subcategory Item Name <span class="text-red">*</span></label>
                                                                            
                                                                            <?php echo Form::text('item_name', null, ['class' => 'form-control','required','id'=>'item_name']); ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col d-flex justify-content-end">
                                                            <input class="btn btn-primary" type="submit" id="frontval" value="Save">
                                                            </div>
                                                        </div>
...
$(document).ready(function () {
 ...
 function loadsubcat(clear='')
    ...
    //     }
    //     var url="<?php echo e(url('admin/subcategory/list/')); ?>";
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qaushas/public_html/resources/views/admin/master/create_subcategory.blade.php ENDPATH**/ ?>