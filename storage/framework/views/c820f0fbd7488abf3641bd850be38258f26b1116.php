									...
									<div class="col-12 mb-3">
										<div class="e-panel card">
											<div class="card-body">
												...
												<?php echo e(Form::hidden('id',0,['id'=>'saleid'])); ?>
...
<input type="text" class="form-control datetimepicker-input" name="sale_start" data-target="#sale_start"  />
...
<input type="text" class="form-control datetimepicker-input" name="sale_end" data-target="#sale_end"  />
...
unset($__errorArgs, $__bag); ?>
															...
															<?php echo Form::text('offer_value', null, ['class' => 'form-control','rows' => 3,'id'=>'offer_value']); ?>
...
unset($__errorArgs, $__bag); ?>
																	...
																	<div class="col-md-6">
																		 <div class="form-group ">
																		 	<?php echo e(Form::label('products','Products',['class'=>''])); ?> <span class="text-red">*</span>

																		 <select id="product" class="form-control chosen-select myselect" multiple name="prd_id[]">
																			<?php if($products): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qaushas/public_html/resources/views/admin/shocking_sale/create.blade.php ENDPATH**/ ?>