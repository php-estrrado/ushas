									...
									<div class="col-12 mb-3">
										<div class="e-panel card">
											<div class="card-body">
												...
												<?php echo e(Form::hidden('id',0,['id'=>'bannerid'])); ?>
                                                                ...
                                                                <select class="form-control custom-select select2" name="glo_lang_cid" required>
																	...
																	<div class="col">
																		<div class="form-group">
																			...
																			<?php echo Form::text('caption', null, ['class' => 'form-control','rows' => 3,'id'=>'caption']); ?>
...
unset($__errorArgs, $__bag); ?>
																...
																<div class="row">
																	...
																	<div class="col">
																		...
																		<option value="<?php echo e($kv['id']); ?>"><?php echo e($kv['title']); ?></option>
																		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																		<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
																	...
																	<div class="col" >
																		<div class="form-group">
																			...
																			<?php echo Form::select('media_type', array('image' => 'Image', 'video' => 'Video'), 'image',['class' => 'form-control','required','id'=>'media_type']); ?>
...
unset($__errorArgs, $__bag); ?>
															...
															<?php echo Form::text('media_link', null, ['class' => 'form-control','rows' => 3,'id'=>'media_link','placeholder'=>'Eg: youtube.com/embed/ScMzIvxBSi4']); ?>
																...
																<div class="row">
																	 ...
																	 <div class="col">
																		<div class="form-group">
																			...
																			<?php echo Form::text('btn_text', null, ['class' => 'form-control','rows' => 3,'id'=>'btn_text']); ?>
...
unset($__errorArgs, $__bag); ?>
																	 ...
																	 <div class="col">
																		<div class="form-group">
																			...
																			<?php echo Form::text('btn_link', null, ['class' => 'form-control','rows' => 3,'id'=>'btn_link']); ?>
																...
																<div class="row">
																	...
																	<div class="col-md-6" id="alt_text_div">
																		<div class="form-group">
																			...
																			<?php echo Form::text('alt_text', null, ['class' => 'form-control','rows' => 3,'id'=>'alt_text']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qaushas/public_html/resources/views/admin/banners/create.blade.php ENDPATH**/ ?>