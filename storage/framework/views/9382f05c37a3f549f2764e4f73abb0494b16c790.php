...
<?php $__env->startSection('page-header'); ?>
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Customer Points Log</h4>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo e(url('/admin/customer/points')); ?>"><i class="fe fe-grid mr-2 fs-14"></i>Points</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Customer Points Log</a></li>
								</ol>
							</div>
											...
											<div class="media mr-4">
												...
												<div class="media mr-4">
													...
													<div class="media-body">
														...
														<div class="font-weight-normal1">
														<?php if($points->balance > 0): ?>	<?php echo e(($points->balance)); ?>
								...
								<div class="card">
														...
														<table id="wallet-table" class="wallet-table table table-striped table-bordered w-100 text-nowrap">
															<thead>
																<tr>
																	...
																	<th class="border-bottom-0 w-20">Sales ID</th>
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="align-middle" >
																		<div class="d-flex">
																		<h6 class=" font-weight-bold">
																		 <?php if($row->sales_id): ?><?php echo e($row->sales_id); ?> <?php else: ?> <?php echo e("-"); ?> <?php endif; ?>
																		</h6>
                                                                        </div>
																	</td>
																	<td class="align-middle" >
									...
									<div class="card-footer">
										<div class="row">
											...
											<a href="<?php echo e(route('customer.points')); ?>"  class="mr-2 btn btn-secondary" >Back</a>			
											</div>
										</div>
									</div>
								</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qaushas/public_html/resources/views/customer/points/log_view.blade.php ENDPATH**/ ?>