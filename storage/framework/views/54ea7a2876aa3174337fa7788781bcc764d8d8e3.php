										...
										<div class="e-table">
											<div class="table-responsiv table-lg mt-3">
												<?php  $default_lang =DB::table('glo_lang_lk')->where('is_active', 1)->first();
														...
														<div class="row">
															...
															<div class="col-md-6 col-lg-6 col-xl-6 col-sm-12">
																<div class="form-group row">
																	...
																	<div class="col-md-8">
																	<p class="view_value"><?php echo e($default_lang->glo_lang_name); ?></p>
																   </div>
																</div>
																<div class="form-group row">
																	<label class="form-label col-md-4">Subcategory Name:</label>
																	<div class="col-md-8">
																	<p class="view_value"><?php echo e($subcategory_name->content); ?></p>
																</div>
																</div>
																<div class="form-group row">
																	<label class="form-label col-md-4">Category Name:</label>
																	<div class="col-md-8">
																	<p class="view_value"><?php echo e($category_name->content); ?></p>
																</div>
																</div>
															...
															<div class="col-md-6 col-lg-6 col-xl-6 col-sm-12">
                                                                ...
                                                                <div class="form-group row">
																	...
																	<div class="col-md-8">
																	<p class="view_value"> <?php echo e($subcategory->local_name); ?> </p>
																</div>
																</div>
																<div class="form-group row">
																	<label class="form-label col-md-4">Parent Category:</label>
																	<div class="col-md-8">
																	<p class="view_value"><?php echo e($parent_content); ?></p>
																</div>
																</div>
																<div class="form-group row">
																	<label class="form-label col-md-4">Subcategory Description:</label>
																	<div class="col-md-8">
																	<p class="view_value"><?php echo e($desc); ?></p>
																</div>
																</div>
																<div class="form-group row">
														...
														<label class="form-label">Extra Fields: <span class="text-red"></span></label>
														<ul>
														<?php $__currentLoopData = $extra_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e_field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<?php if(in_array($e_field->id,$existing_fields)){ ?> <li><?php echo e($e_field->name); ?></li> <?php } ?> 
														...
														<div class="row" style="margin-top: 30px;">
															<div class="col d-flex justify-content-end">
															    <a href="<?php echo e(route('admin.subcategory')); ?>"  class="mr-2 btn btn-secondary" >Back</a>  
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qaushas/public_html/resources/views/admin/master/view_subcategory.blade.php ENDPATH**/ ?>