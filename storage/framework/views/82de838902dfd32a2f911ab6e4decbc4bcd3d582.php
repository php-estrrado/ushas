...
<div id="content_list"><?php echo $__env->make('admin.bestpurchase_report.list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
...
<script>
    ...
    $(document).ready(function(){ 
        ...
        $('body').on('change','#start_date',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(url("admin/report/best-purchase-report")); ?>',
        ...
        $('body').on('change','#end_date',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(url("admin/report/best-purchase-report")); ?>',
                data: {end_date: this.value, start_date: $('#start_date').val(),seller: $('#seller').val(),viewType: 'ajax'},
                success: function (data) {
                    $('#content_list').html(data); 
                } 
            });
        ...
        $('body').on('change','#seller',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(url("admin/report/best-purchase-report")); ?>',
                data: {seller: this.value, start_date: $('#start_date').val(),end_date: $('#end_date').val(),viewType: 'ajax'},
                success: function (data) {
                    $('#content_list').html(data); 
                } 
            });
    ...
    function updateStatus(id,rowId,status,url,row,field,smsg){
        $.ajax({
            type: "POST",
            url: url,
            data: { "_token": "<?php echo e(csrf_token()); ?>", id: id, value: status,field: field, field, page: row, start_date: $('#start_date').val(), end_date: $('#date_date').val(),type: 'request'},
            success: function (data) {
                if(field == 'is_deleted'){ 
...
<?php /**PATH /home/qaushas/public_html/resources/views/admin/bestpurchase_report/filter.blade.php ENDPATH**/ ?>