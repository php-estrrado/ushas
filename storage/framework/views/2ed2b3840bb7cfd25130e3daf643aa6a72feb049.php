...
.app-header.header {
        background: <?php echo e(config('settings.dashboard_bg')); ?> !important;
}
.header-icon {
    color:  <?php echo e(config('settings.menu_icon_color')); ?> !important;
    fill:  <?php echo e(config('settings.menu_icon_color')); ?> !important;
...
.card-header::before {
    background-color:  <?php echo e(config('settings.menu_icon_color')); ?> !important;
}
.header-brand-img {
...
input:checked~.switch-paddle {
    background:  <?php echo e(config('settings.menu_icon_color')); ?> !important;
}
.app-sidebar__logo {
    padding: 10px 15px !important;
    height: 90px !important;
}
 </style><?php /**PATH /home/qaushas/public_html/resources/views/includes/config-styles.blade.php ENDPATH**/ ?>