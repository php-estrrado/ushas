...
<?php echo e(Form::open(array('url' => "admin/user-roles/save", 'id' => 'userForm', 'name' => 'userForm', 'class' => '','files'=>'true'))); ?>
												...
												<?php echo e(Form::hidden('id',0,['id'=>'roleid'])); ?>
																...
																<div class="row">
																	<div class="col">
																		<div class="form-group">
																			...
																			<?php echo Form::text('usr_role_name', null, ['class' => 'form-control','id'=>'usr_role_name']); ?>
																...
																<div class="row">
																	<div class="col mb-3">
																		<div class="form-group">
																			...
																			<?php echo Form::textarea('usr_role_desc', null, ['class' => 'form-control','id'=>'usr_role_desc', 'rows' => '3']); ?>
...
unset($__errorArgs, $__bag); ?>
 ...
 <?php if($modules && count($modules) > 0): ?>
    ...
    <input class=' switch-input status-btn ser_status' name="modules[<?php echo e($pt['id']); ?>]['view']" data-selid="<?php echo e($pt['id']); ?>" id="view-<?php echo e($pt['id']); ?>" value="1"  type="checkbox" />
    ...
    <span class="switch-inactive" aria-hidden="true">Inactive</span>
		...
		<input class='switch-input status-btn ser_status' name="modules[<?php echo e($pt['id']); ?>]['edit']" id="edit-<?php echo e($pt['id']); ?>" data-selid="<?php echo e($pt['id']); ?>" value="1"  type="checkbox"  />
		...
		<input class=' switch-input status-btn ser_status' name="modules[<?php echo e($pt['id']); ?>]['delete']" id="delete-<?php echo e($pt['id']); ?>" data-selid="<?php echo e($pt['id']); ?>" value="1"  type="checkbox"  />
                                ...
                                <?php $__currentLoopData = $child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-2 sub-title <?php echo e($nrow); ?> citems">
                                       						<div class="switch viewbox">
		<input class='switch-input status-btn ser_status' name="modules[<?php echo e($ch['id']); ?>]['view']" id="ch-view-<?php echo e($ch['id']); ?>" data-selid="<?php echo e($ch['id']); ?>" value="1"  type="checkbox"  />
		...
		<span class="switch-inactive" aria-hidden="true">Inactive</span>
								...
								<div class="col-2 sub-title <?php echo e($nrow); ?> citems">
									<div class="switch editbox">
		<input class='switch-input status-btn ser_status' name="modules[<?php echo e($ch['id']); ?>]['edit']" data-selid="<?php echo e($ch['id']); ?>" id="ch-edit-<?php echo e($ch['id']); ?>" value="1"  type="checkbox"  />
		...
		<span class="switch-inactive" aria-hidden="true">Inactive</span>
								...
								<div class="col-2 sub-title <?php echo e($nrow); ?> citems">
										<div class="switch deletebox">
		<input class='switch-input status-btn ser_status' name="modules[<?php echo e($ch['id']); ?>]['delete']" id="ch-delete-<?php echo e($ch['id']); ?>" data-selid="<?php echo e($ch['id']); ?>" value="1"  type="checkbox" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qaushas/public_html/resources/views/admin/user-roles/create.blade.php ENDPATH**/ ?>