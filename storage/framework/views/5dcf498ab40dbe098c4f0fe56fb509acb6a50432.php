...
<div id="content_list"><?php echo $__env->make('admin.wishlist_report.list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
...
<script>
    ...
    $(document).ready(function(){ 
        ...
        $('body').on('change','#start_date',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(url("admin/report/wishlist-report")); ?>',
...
<?php /**PATH /home/qaushas/public_html/resources/views/admin/wishlist_report/filter.blade.php ENDPATH**/ ?>