						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<div class="btn btn-list">
									...
									<a href="<?php echo e(url('admin/banners/create/')); ?>"  class="btn btn-primary addmodule"><i class="fe fe-plus mr-1"></i> Add New</a>
								</div>
							</div>
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="align-middle" >
																		<div class="d-flex">
																		    	<?php	$title = Str::of($row['title'])->limit(20); ?>
																		<p><?php echo e($title); ?></p>
																	</div>
																	</td>
																	<td class="align-middle" >
																		<div class="d-flex">
																		<p><?php echo e($row['banner_type']); ?></p>
																	</div>
																	</td>
																	<td class="align-middle" >
																	...
																	<td class="align-middle" >
																		<div class="d-flex">
																		<p><?php if(isset($row['alt_text'])): ?> <?php echo e($row['alt_text']); ?> <?php else: ?> <?php echo e("-"); ?> <?php endif; ?></p>
																	</div>
																	</td>
																	<!--<td class="align-middle" >-->
																	<!--	<div class="d-flex">-->
																	<!--	<p><?php if(isset($row['btn_link'])): ?> <?php echo e($row['btn_link']); ?> <?php else: ?> <?php echo e("-"); ?> <?php endif; ?></p>-->
																	<!--</div>-->
																	<!--</td>-->
																	...
																	<span class="switch-inactive" aria-hidden="true">Inactive</span>
																	 ...
																	 <td class="align-middle">
																		<div class="btn-group align-top">
																			...
																			<a href="<?php echo e(url('admin/banners/edit/')); ?>/<?php echo e($row['id']); ?>"   class="mr-2 btn btn-info btn-sm editmodule"><i class="fe fe-edit mr-1"></i> Edit</a>
...
$('body').removeClass('timer-alert');
		...
		$.ajax({
		type: "POST",
		url: '<?php echo e(url("/admin/banners/delete")); ?>',
...
$('body').on('change','.ser_status',function(){  
        ...
        $.ajax({
        type: "POST",
        url: '<?php echo e(url("/admin/banners/status")); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qaushas/public_html/resources/views/admin/banners/list.blade.php ENDPATH**/ ?>