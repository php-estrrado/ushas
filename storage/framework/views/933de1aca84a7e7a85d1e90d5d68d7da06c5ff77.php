																...
																<div class="row">
																	<div class="col">
																		<div class="form-group">
																			...
																			<?php echo Form::text('brand_name', null, ['class' => 'form-control','id'=>'brand_name']); ?>
...
unset($__errorArgs, $__bag); ?>
																...
																<div class="row">
																	<div class="col mb-3">
																		<div class="form-group">
																			<label class="form-label">Brand Description <span class="text-red">*</span></label>
																			<?php echo Form::textarea('brand_desc', null, ['class' => 'form-control','id'=>'brand_desc', 'rows' => '3']); ?>
...
unset($__errorArgs, $__bag); ?>
                                                           ...
                                                           <label class="form-label">Brand Image <span class="text-red">*</span></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qaushas/public_html/resources/views/admin/brands/create.blade.php ENDPATH**/ ?>