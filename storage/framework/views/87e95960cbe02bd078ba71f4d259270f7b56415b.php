								...
								<div class="e-table">
									<div class="table-responsiv table-lg mt-3">
										<?php echo e(Form::open(array('url' => "/admin/delivery/save", 'id' => 'deliveryForm', 'name' => 'deliveryForm', 'class' => ''))); ?>
										    ...
										    <?php echo e(Form::hidden('id',0,['id'=>'deliveryid'])); ?>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <?php echo Form::text('delivery_type', null, ['class' => 'form-control','rows' => 3,'id'=>'delivery_type']); ?>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <?php echo Form::textarea('delivery_description', null, ['class' => 'form-control','rows' => 4,'cols'=>54, 'id'=>'delivery_description']); ?>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <?php echo Form::text('delivery_charges', null, ['class' => 'form-control','rows' => 3,'id'=>'delivery_charges']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qaushas/public_html/resources/views/admin/delivery/create.blade.php ENDPATH**/ ?>