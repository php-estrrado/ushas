 ...
 <div id='lbError' class='warning'></div>
    ...
    <div id="prd_imgs">
        <div id="img_row_0" class="col-12 fl img_row">
            <div class="col-lg-6 fl">
                <div class="form-group">
                    ...
                    <?php echo e(Form::file('',['id'=>'image_'.$n_img,'class'=>'form-control img image','placeholder'=>'Choose Image','accept'=>'image/*'])); ?>
        ...
        <div class="col-lg-5 col-8 fl">
                ...
                <div id="image_<?php echo e($n_img); ?>_img" style="background:#9d9d9d;width:238px;padding:34px 15px;height:170px;"></div>
			   </div>
            </div> <?php $n_img++; ?>
            <div class="clr"></div>
        </div>
...
<div id="add_more_img" class="d-none">
    <div id="img_row_id" class="col-12 fl img_row">
        <div class="col-lg-6 fl">
            <div class="form-group">
                <?php echo e(Form::file('',['id'=>'image_file_id','class'=>'form-control img image','placeholder'=>'Choose Image','accept'=>'image/*'])); ?>
...
$('body').on('click','.upload-image', function(ev){
  resize.croppie('result', {
    ...
    $.ajax({
      url: "<?php echo e(route('croppie.upload-image')); ?>",
      type: "POST",
      data: {"image":img},
...
</script><?php /**PATH C:\wamp64\www\ushas-dev\resources\views/admin/products/details/image.blade.php ENDPATH**/ ?>