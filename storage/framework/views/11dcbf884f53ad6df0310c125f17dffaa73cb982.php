						...
						<div class="col-md-6">
							<div class="">
								<div class="text-white">
									<div class="card-body">
									    <center><img src="<?php echo e(URL::asset(config('settings.logo_login'))); ?>" class="logo" alt="<?php echo e(config('settings.app_name')); ?>"></center>
...
unset($__errorArgs, $__bag); ?>
												...
												<div class="row">
													<div class="col-12">
														<button type="submit" class="btn btn btn-block px-4" style="background: #fff; color: #006fb4 !important; padding: 10px;  border-color:  #006fb4;">Login</button>
													</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qaushas/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>