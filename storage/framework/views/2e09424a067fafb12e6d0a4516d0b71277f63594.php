        ...
        <div class="page-header">
            ...
            <div class="page-rightheader" style="display:flex; flex-direction: row; justify-content: center; align-items: center">
                ...
                <div class="btn btn-list">
                    <a href="<?php echo e(url('admin/delivery/create/')); ?>"  class="btn btn-primary addmodule"><i class="fe fe-plus mr-1"></i> Add New</a>
                </div>
            </div>
        </div>
    <!--End Page header-->
										...
										<table class="table table-bordered border-top text-nowrap banners" id="banners">
											<thead>
												<tr>
                                                    ...
                                                    <th class="border-bottom-0 w-15">Delivery Type</th>
                                                    <th class="border-bottom-0 w-15">Delivery Description</th>
                                                    <th class="border-bottom-0 w-15">Status</th>
                                                    <th class="border-bottom-0 w-10 notexport">Actions</th>
												</tr>
											</thead>
											<tbody>
												<?php if($delivery && count($delivery) > 0): ?>
                    								<?php $__currentLoopData = $delivery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<tr>
                                                            ...
                                                            <td class="align-middle" >
                                                                <div class="d-flex">
                                                                    <?php	$delivery_type_name = Str::of($row['delivery_type_name'])->limit(20); ?>
                                                                    <p><?php echo e($delivery_type_name); ?></p>
                                                                </div>
                                                            </td>
                                                            <td class="align-middle" >
                                                                <div class="d-flex">
                                                                    <p><?php echo e($row['delivery_description']); ?></p>
                                                                </div>
                                                            </td>																	
                                                            ...
                                                            <td class="align-middle">
                                                                <div class="btn-group align-top">
                                                                    <a href="<?php echo e(url('admin/delivery/edit/')); ?>/<?php echo e($row['id']); ?>"   class="mr-2 btn btn-info btn-sm editmodule"><i class="fe fe-edit mr-1"></i> Edit</a>
...
<?php $__env->startSection('js'); ?>
		...
		<script src="<?php echo e(URL::asset('admin/assets/js/datatable/tables/banners-datatable.js')); ?>"></script>
...
$('body').removeClass('timer-alert');
		...
		swal({
		    ...
		    text: "Are you sure you want to delete this Delivery type?",
		    // type: "input",
        ...
        function(inputValue){
            if (inputValue == true) {
                $.ajax({
                    type: "POST",
                    url: '<?php echo e(url("/admin/delivery/delete")); ?>',
...
// Custom filtering function which will search data in column four between two values
    ...
    $('body').on('change','.ser_status',function(){ 
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo e(url("/admin/delivery/status")); ?>',
            ...
            success: function (data) {
                ...
                if(data ==1)
                {
                    if(sestatus ==1)
                    {
                        ...
                        toastr.success("Delivery Type activated successfully.");                    
                    }
                    else
                    {
                        jQuery('#status-'+selid).closest("td").attr("data-search","Inactive");
                        toastr.success("Delivery Type deactivated successfully."); 
                    }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qaushas/public_html/resources/views/admin/delivery/list.blade.php ENDPATH**/ ?>