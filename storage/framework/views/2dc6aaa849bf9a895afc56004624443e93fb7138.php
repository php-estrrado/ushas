...
<?php echo e(Form::open(array('url' => "admin/occasions/save", 'id' => 'occasionsForm', 'name' => 'occasionsForm', 'class' => '','files'=>'true'))); ?>
												...
												<input type="hidden" name="id" value="<?php echo e($occasion['id']); ?>">
												<input type="hidden" name="occasion_name_cid" value="<?php echo e($occasion['occasion_name_cid']); ?>">
																...
																<div class="row">
																	<div class="col">
																		<div class="form-group">
																			...
																			<input type="text"  class="form-control" name="occasion" value="<?php echo e($occasion['occasion']); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="d-flex">
                                                                <img src="<?php echo e(url('uploads/storage/app/public/occasions/'.$occasion['image'])); ?>" alt="<?php echo e($occasion['image']); ?>"  style="height: 150px; max-height:150px; width:auto;">
                                                                <input type="hidden" value="<?php echo e($occasion['image']); ?>" name="image_file">
                                                            </div>
                                                        </div>
                                                        </div>
                                                        <?php endif; ?>
														<div class="row">
                                                           ...
                                                           <input type="file" class="dropify <?php $__errorArgs = ['occasion_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" data-height="180"  accept="image/*" name="occasion_image" data-allowed-file-extensions='["png", "jpg", "jpeg"]' />
															   ...
															   <?php $__errorArgs = ['occasion_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
																...
																<div class="col">
																		<div class="form-group">
																			...
																			<?php echo Form::select('is_active', array('1' => 'Active', '0' => 'Inactive'), $occasion['is_active'],['class' => 'form-control','required','id'=>'module_status']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qaushas/public_html/resources/views/admin/occasions/edit.blade.php ENDPATH**/ ?>